...
\item \textbf{Code availability:} The EGCD inference pipeline, the evaluation scripts, and the per-item correctness outputs used for the exact paired McNemar tests will be made available upon publication; the split IDs are already released in the code repository (canonical\_split.json).
